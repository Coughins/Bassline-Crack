...
platform_check_distance = 1
vine_check_distance = 1
situated_check_distance = 1
slope_check_extra_distance = 2
right = new vec2(1, 0)
down = new vec2(0, 1)
...
var _saved_weapon = savedata_get_active("weapon");
var _weapon_asset = oGun;
if (_saved_weapon != 0 && _saved_weapon != "" && _saved_weapon != -1 && _saved_weapon != undefined) {
	_weapon_asset = asset_get_index(_saved_weapon);
	if (_weapon_asset == -1) _weapon_asset = oGun;
}
player_set_weapon(_weapon_asset)
